    ...
    {                                                                                                                                                          \
        ...
        {                                                                                                                                                      \
            ...
            return donotuse_##p;                                                                                                                               \
                                                                                                                                                               ...
                                                                                                                                                               \
private:                                                                                                                                                       \
    Microsoft::UI::Xaml::Input::ICommand ^ donotuse_##p;                                                                                                         \
                                                                                                                                                               \
public:
    ...
    {                                                                                                                                                          \
        ...
        {                                                                                                                                                      \
            SetValue(s_##n##Property, value);                                                                                                                  \
                                                                                                                                                               ...
                                                                                                                                                               \
private:                                                                                                                                                       \
    static Microsoft::UI::Xaml::DependencyProperty ^ s_##n##Property;                                                                                            \
                                                                                                                                                               \
private:
...
#define DEPENDENCY_PROPERTY_ATTACHED(type, name)                                                                                                               \
    static type Get##name(Microsoft::UI::Xaml::DependencyObject ^ target)                                                                                        \
    {                                                                                                                                                          \
        return safe_cast<type>(target->GetValue(s_##name##Property));                                                                                          \
    }                                                                                                                                                          \
    static void Set##name(Microsoft::UI::Xaml::DependencyObject ^ target, type value)                                                                            \
    {                                                                                                                                                          \
...
namespace CalculatorApp
{
    ...
    namespace ViewModel::Common
    {
        ...
        public:
            ...
            static Microsoft::UI::Xaml::Media::SolidColorBrush ^ GetContrastColor(Windows::UI::Color backgroundColor);
