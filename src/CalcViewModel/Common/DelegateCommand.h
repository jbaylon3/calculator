...
namespace CalculatorApp::ViewModel
{
    namespace Common
    {
        ...
        public ref class DelegateCommand sealed : public Microsoft::UI::Xaml::Input::ICommand
        {
        public:
        ...
        private:
            ...
            virtual void ExecuteImpl(Platform::Object ^ parameter) sealed = Microsoft::UI::Xaml::Input::ICommand::Execute
            {
                m_handler->Invoke(parameter);
            }

            virtual bool CanExecuteImpl(Platform::Object ^ parameter) sealed = Microsoft::UI::Xaml::Input::ICommand::CanExecute
            {
                return true;
            }
            ...
            {
                virtual Windows::Foundation::EventRegistrationToken add(Windows::Foundation::EventHandler<Platform::Object ^> ^ handler) sealed = Microsoft::UI::Xaml::Input::ICommand::CanExecuteChanged::add
                {
                    return m_canExecuteChanged += handler;
                }
                virtual void remove(Windows::Foundation::EventRegistrationToken token) sealed = Microsoft::UI::Xaml::Input::ICommand::CanExecuteChanged::remove
                {
